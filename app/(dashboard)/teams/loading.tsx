    ...
    <div className="flex flex-col gap-0 animate-reveal">
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-0.5 rounded-lg border p-0.5" style={{ background: "var(--bg)", borderColor: "var(--border-strong)" }}>
          <span className="rounded-md px-2.5 py-1 text-xs font-semibold" style={{ background: "var(--bg-elevated)", color: "var(--fg)" }}>Most Members</span>
      ...
      <div className="card-static mb-3 flex items-center gap-3 p-3">
        <input className="input flex-1" placeholder="Search teams..." disabled readOnly />
        <span className="btn btn-primary shrink-0">Add Team</span>
      </div>
