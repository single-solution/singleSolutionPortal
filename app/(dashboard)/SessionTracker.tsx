    ...
    <AnimatePresence>
      <motion.div
        ...
        {session.isStale && session.active && (
              <span className="text-[11px] font-semibold opacity-75 tracking-wide">inactive</span>
            )}
          ...
          {showCoords && liveCoords && isActive && (
            <>
              <span className="h-3.5 w-px bg-white/40 rounded-full" />
              <span className="text-[11px] font-semibold tabular-nums whitespace-nowrap opacity-80 tracking-wide drop-shadow-sm">
