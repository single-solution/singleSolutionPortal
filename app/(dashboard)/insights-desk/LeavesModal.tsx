      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <motion.div
              className={`relative mx-0 sm:mx-4 flex flex-col rounded-none sm:rounded-xl border shadow-xl overflow-hidden ${showSidebar ? "w-full max-w-6xl h-[100dvh] sm:h-[80vh]" : "w-full max-w-3xl h-[100dvh] sm:h-[80vh]"}`}
