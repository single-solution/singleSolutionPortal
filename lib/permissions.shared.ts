...
export const PERMISSION_META: Record<keyof IPermissions, { label: string; desc: string }> = {
  ...
  designations_view:   { label: "View designations",   desc: "See designation titles and their default permissions in the organization chart" },
  designations_manage: { label: "Manage designations",  desc: "Create, edit, toggle, and delete designation definitions in the organization chart" },
...
export const PERMISSION_CATEGORIES: { label: string; icon: string; keys: (keyof IPermissions)[] }[] = [
  ...
  { label: "Organization",  icon: "M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7",  keys: ["organization_view", "organization_manageLinks", "designations_view", "designations_manage"] },
  ...
  { label: "System",        icon: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z",  keys: ["holidays_view", "holidays_manage", "settings_view", "settings_manage"] },
];
